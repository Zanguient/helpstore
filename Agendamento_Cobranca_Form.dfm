object FrmAgendamentoCobranca: TFrmAgendamentoCobranca
  Left = 237
  Top = 141
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Agendamento de Cobran'#231'a '
  ClientHeight = 266
  ClientWidth = 527
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object EdReceber: TdxDBEdit
      ...
      TabOrder = 8
      Visible = False
      OnEnter = EdHistorico1Enter
      OnExit = EdHistorico1Exit
  ...
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.edtCobranca_Listagem
    OnStateChange = DataSourceStateChange
    Left = 197
  end
  object DsMotivo: TDataSource
    AutoEdit = False
    DataSet = dmCadastros2.Motivo_Cobranca
    Left = 261
  end
