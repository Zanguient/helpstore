object FrmBaixaReceberConvenio: TFrmBaixaReceberConvenio
  Left = 181
  Top = 100
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Baixa de Contas '#224' Receber por Conv'#234'nio'
  ClientHeight = 449
  ClientWidth = 624
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object GRID: TdxDBGrid
      ...
      object GRIDCONVENIADO: TdxDBGridColumn
        Width = 189
        BandIndex = 0
        RowIndex = 0
  ...
  object BarManager: TdxBarManager
    ...
    object dxBarEdit1: TdxBarEdit
      ...
      ReadOnly = True
      Text = 
        '  ( F3 ) Localizar    ( F8 ) Selecionados    ( F9 ) Baixar Selec' +
        'ionados    ( F10 ) Seleciona  '
    end
  ...
  object stgFrmBaixaReceberConvenio: TcxPropertiesStore
    Components = <
      item
        Component = DATAFINAL
        Properties.Strings = (
    ...
    StorageName = 'stgFrmBaixaReceberConvenio'
    Left = 152
    Top = 223
  end
end
