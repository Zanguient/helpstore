object FrmCaixaResumoMovtos: TFrmCaixaResumoMovtos
  Left = 239
  Top = 129
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Entradas/Sa'#237'das do Caixa '
  ClientHeight = 461
  ClientWidth = 657
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Movimentos do Caixa Resumo'
      ParentFont = False
      Transparent = True
    end
    ...
    object GRID: TdxDBGrid
      ...
      PreviewFont.Style = []
      RowFooterTextColor = clWindowFrame
      ...
      object GRIDCONTRA_PARTIDA: TdxDBGridColumn
        Width = 167
        BandIndex = 0
        RowIndex = 0
  ...
  object DataSource: TDataSource
    DataSet = DmCaixa.MovimentosResumo
