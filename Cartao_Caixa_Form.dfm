object FrmCartao_Caixa: TFrmCartao_Caixa
  Left = 246
  Top = 135
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Cart'#227'o do Caixa '
  ClientHeight = 368
  ClientWidth = 624
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object btnAdministradoras: TSpeedButton
      Left = 197
      Top = 74
      Width = 23
      Height = 22
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Movimento de Cart'#245'es no Caixa'
      ParentFont = False
    end
  ...
  object DataSource: TDataSource
    DataSet = DMCaixaFrentista.Cartao2
