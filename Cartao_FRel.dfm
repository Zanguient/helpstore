object FRelCartao: TFRelCartao
  ...
  Caption = ' Relat'#243'rio de Cart'#245'es Cadastrados'
  ClientHeight = 246
  ClientWidth = 339
  Color = clWhite
  ...
  object DsAdministradoras: TDataSource
    AutoEdit = False
