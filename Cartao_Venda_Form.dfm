object FrmCartao_Venda: TFrmCartao_Venda
  Left = 493
  Top = 156
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Cart'#227'o da Venda '
  ClientHeight = 372
  ClientWidth = 628
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object btnAdministradoras: TcxButton
      Left = 199
      Top = 74
      Width = 23
      Height = 22
      Cursor = crHandPoint
      TabOrder = 23
      OnClick = btnAdministradorasClick
      Glyph.Data = {
    ...
    object ckbEntrada: TdxCheckEdit
      Left = 123
      Top = 99
      Width = 121
      Color = clWhite
      ...
      TabOrder = 6
      OnEnter = dxDBEdit2Enter
      OnExit = ckbEntradaExit
      OnKeyDown = dxDBEdit1KeyDown
      Caption = 'Entrada'
    end
    object edtParcelas: TdxSpinEdit
      Left = 75
      Top = 99
      Width = 39
      Font.Charset = DEFAULT_CHARSET
  ...
  object Cartao: TIBDataSet
    ...
    InsertSQL.Strings = (
      ...
      '  (PLANILHA, ADMINISTRADORA, CLIENTE, CNPJ, CODIGO, CONCILIADO, '
      'CONTA, '
      '   CPF_CNPJ, DATA, DOCUMENTO, NUM_BANCO, NUM_CARTAO, NUM_CONTA, '
      'REEMBOLSO, '
      
        '   TIPO_DOC, USUARIO, VALOR, VENDA, PESSOA_FJ, TIPO, NUM_PARCELA' +
        'S, '
      'TAXA, '
      '   TURNO, TROCA)'
      'values'
      
        '  (:PLANILHA, :ADMINISTRADORA, :CLIENTE, :CNPJ, :CODIGO, :CONCIL' +
        'IADO, '
      ':CONTA, '
      '   :CPF_CNPJ, :DATA, :DOCUMENTO, :NUM_BANCO, :NUM_CARTAO, '
      ':NUM_CONTA, :REEMBOLSO, '
    ...
    SelectSQL.Strings = (
      'select c.*'
      'from FIN_MOVIMENTO_CARTAO c'
      'Where c.CNPJ = :CNPJ'
      'and ((c.venda = :venda) or (:venda = 0))'
      'and ((c.troca = :troca) or (:troca = 0))'
      'and ((c.planilha = :planilha) or (:planilha = 0))')
    ModifySQL.Strings = (
    ...
    GeneratorField.Generator = 'FIN_CARTAO_GE'
    ...
    object CartaoTIPO: TIBStringField
      ...
      OnGetText = CartaoTIPOGetText
      OnSetText = CartaoTIPOSetText
      OnValidate = CartaoTIPOValidate
      FixedChar = True
      Size = 3
    end
    ...
    object CartaoCOD_ACERTOCONTA: TIntegerField
      FieldName = 'COD_ACERTOCONTA'
      Origin = '"FIN_MOVIMENTO_CARTAO"."COD_ACERTOCONTA"'
    end
  end
end
