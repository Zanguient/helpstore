object FrmCheque_Contabilidade: TFrmCheque_Contabilidade
  Left = 231
  Top = 168
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cheques - Emiss'#227'o'
  ClientHeight = 330
  ClientWidth = 623
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object Label9: TcxLabel
      Left = 213
      Top = 16
      Caption = 'Total / Desdobrado : Remanescente'
      ParentFont = False
      Transparent = True
    end
    ...
    object edPredate: TdxDBDateEdit
      Left = 518
      Top = 101
      Width = 88
      Color = clWhite
  ...
  object DataSource: TDataSource
    DataSet = DmFinanceiro.DesdChequeCtb
