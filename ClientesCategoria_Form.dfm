object FrmClientesCategoria: TFrmClientesCategoria
  Left = 420
  Top = 186
  ...
  object Categoria: TIBDataSet
    Database = DmApp.Database
    Transaction = DmApp.Transaction
    BeforePost = CategoriaBeforePost
    DeleteSQL.Strings = (
    ...
    Left = 321
    Top = 8
    object CategoriaCNPJ: TIBStringField
      FieldName = 'CNPJ'
    ...
    object CategoriaCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = '"GLO_CLIENTES_CATEGORIA"."CODIGO"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CategoriaNOME: TIBStringField
      FieldName = 'NOME'
