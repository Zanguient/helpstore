object FRelClientesInativos: TFRelClientesInativos
  Left = 199
  Top = 128
  BorderStyle = bsDialog
  Caption = 'Rel. Listagem de Clientes Inativos'
  ClientHeight = 118
  ClientWidth = 363
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object EdTempo: TdxCurrencyEdit
      Left = 101
      Top = 9
      Width = 44
      Font.Charset = DEFAULT_CHARSET
    ...
    object CkTipo: TdxCheckEdit
      ...
      OnExit = EdTempoExit
      OnKeyDown = cmbPessoaKeyDown
      Caption = 'Somente os que nunca compraram'
      OnChange = CkTipoChange
    end
  end
