object frmComandas: TfrmComandas
    ...
    object GRID: TdxDBGrid
      ...
      SummaryGroups = <
        item
          ...
          SummaryItems = <
            item
              ColumnName = 'GRIDQUANTIDADE'
              SummaryField = 'QUANTIDADE'
              SummaryFormat = '(SUM=0.00)'
              SummaryType = cstSum
            end
            item
      ...
      object GRIDQUANTIDADE: TdxDBGridMaskColumn
        ...
        SummaryFooterFormat = 'Sum is 0.00'
      end
      object GRIDPRECO_UNITARIO: TdxDBGridMaskColumn
        Width = 101
        BandIndex = 0
        RowIndex = 0
      ...
      object GRIDCOMANDA: TdxDBGridMaskColumn
        Sorted = csUp
        Width = 65
        BandIndex = 0
        RowIndex = 0
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmPdv.Comandas
    Left = 288
    Top = 136
  end
  object stgFrm_Comandas: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
