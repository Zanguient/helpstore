object FrmCopiaNota: TFrmCopiaNota
  Left = 241
  Top = 203
  BorderStyle = bsDialog
  Caption = '  Imprime C'#243'pia da Nota / Cupom Fiscal'
  ClientHeight = 97
  ClientWidth = 304
  Color = clWhite
  ...
  object Actions: TActionList
    ...
    object ActAlteraNumero: TAction
      Caption = 'ActAlteraNumero'
      ShortCut = 120
    end
  ...
  object Extenso: TValorPorExtenso
