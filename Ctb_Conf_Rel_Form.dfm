object FrmCtbConfRel: TFrmCtbConfRel
  Left = 60
  Top = 143
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Ctb Configura Relat'#243'rios'
  ClientHeight = 359
  ClientWidth = 595
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Ctb Configura Relat'#243'rio'
      ParentFont = False
      Transparent = True
    end
    ...
    object pc: TcxPageControl
      ...
      object dxTabSheet2: TcxTabSheet
        ...
        object GRIDSELECIONADAS: TdxDBGrid
          Left = 16
          Top = 16
          Width = 217
          Height = 217
          ...
          SummarySeparator = ', '
          TabOrder = 0
          DataSource = DsContasSelecionadas
          ...
          object GRIDSELECIONADASColumn1: TdxDBGridMaskColumn
        ...
        object GRIDCONTAS: TdxDBGrid
          ...
          LookAndFeel = lfFlat
          OptionsBehavior = [edgoAutoSearch, edgoAutoSort, edgoDragScroll, edgoEnterShowEditor, edgoImmediateEditor, edgoTabThrough, edgoVertThrough]
          object GRIDCONTASNOME: TdxDBGridMaskColumn
          ...
          object GRIDCONTASCONTA: TdxDBGridColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CONTA'
          end
  ...
  object DsContas: TDataSource
    AutoEdit = False
    DataSet = DmPlano.PLANO_CONF_REL
    Left = 336
    Top = 120
  end
  object DsContasSelecionadas: TDataSource
    AutoEdit = False
    DataSet = DmPlano.VER_CTB_CONFIGURA_REL_CONTAS
    Left = 336
    Top = 176
  end
end
