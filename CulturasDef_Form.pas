...
procedure TFrmCulturas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  //
  If FrmCulturas.FormStyle = fsMDIChild Then
  Begin
...
procedure TFrmCulturas.ActIncluirExecute(Sender: TObject);
begin
...
procedure TFrmCulturas.ActExcluirExecute(Sender: TObject);
begin
...
procedure TFrmCulturas.ActPostExecute(Sender: TObject);
begin
  Try
...
procedure TFrmCulturas.ActCancelExecute(Sender: TObject);
begin
...
procedure TFrmCulturas.FormShow(Sender: TObject);
begin
...
procedure TFrmCulturas.FormCreate(Sender: TObject);
begin
  //
...
procedure TFrmCulturas.ActListagemExecute(Sender: TObject);
begin
  //
...
procedure TFrmCulturas.ActLocalizarExecute(Sender: TObject);
begin
  try
...
procedure TFrmCulturas.dxDBEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmCulturas.pnlClientResize(Sender: TObject);
begin
  b2.Width := pnlClient.Width - 17;
  LblRegistros.Left := pnlClient.Width - 11 - LblRegistros.Width;
end;

procedure TFrmCulturas.DataSourceStateChange(Sender: TObject);
begin
  If DataSource.State in dsEditModes Then
     Begin
...
procedure TFrmCulturas.ActFecharExecute(Sender: TObject);
begin
  If FrmCulturas.FormStyle = fsMDIChild Then
...
procedure TFrmCulturas.DataSourceDataChange(Sender: TObject; Field: TField);
begin
