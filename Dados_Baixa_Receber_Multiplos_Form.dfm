object FrmDadosBaixaReceberSelecao: TFrmDadosBaixaReceberSelecao
  Left = 210
  Top = 112
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Baixa de Contas a Receber por Sele'#231#227'o'
  ClientHeight = 457
  ClientWidth = 624
  Color = 15396334
  ...
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.VerReceberADM2
    Left = 93
    Top = 192
  end
