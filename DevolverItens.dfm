object FrmDevolverItens: TFrmDevolverItens
  Left = 167
  Top = 226
  Width = 759
  Height = 350
  Caption = 'FrmDevolverItens'
  Color = clBtnFace
  ...
  object GridItens: TdxDBGrid
    ...
    object GridItensDEVOLVIDO: TdxDBGridColumn
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DEVOLVIDO'
    end
    ...
    object GridItensDEVOLVER: TdxDBGridColumn
      Color = clMenu
      Width = 67
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DEVOLVER'
      SummaryFooterType = cstSum
      SummaryFooterField = 'DEVOLVIDO'
      SummaryField = 'DEVOLVIDO'
    end
  end
  object pnlDevolver: TPanel
    Left = 240
    Top = 112
    Width = 137
    Height = 49
    ...
    object edtDevolver: TDBEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnEnter = edtDevolvidoEnter
      OnExit = edtDevolverExit
      OnKeyDown = edtDevolverKeyDown
    end
  end
  ...
  object rptSerieDevolucao: TppReport
    ...
    Template.FileName = 'C:\Documents and Settings\Marcel Alves\Desktop\devolucao.txt'
    ...
    object ppFooterBand4: TppFooterBand
      ...
      object ppLabel95: TppLabel
        ...
        Border.Visible = False
        Border.Weight = 1.000000000000000000
        Caption = 'Obs. Declaro que recebi as quantidades mencionadas acima.'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Courier New'
