  ...
  object Empresas: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into SIS_EMPRESAS'
        ...
        '   ALTERA_VLR_CNT_PAGAR, ATIVA_AGENTE, ATUALIZA_ARQ_EXTERNO, AVI' +
        'SO_ESTOQUE_MIN, '
      
        '   BAIRRO, BCH_ATIVO, BCH_AUTO_IMPORTA, BCH_CONC_CODIGO_PRODUTO,' +
        ' BCH_EXIBE_DESCONTO, '
      
        '   BCH_FILIAL, BCH_HABILITA_SINC_AUT, BCH_INS_MUN, BCH_NOMECONTA' +
        'TO, BCH_PATH, '
      
        '   BCH_PATH_PEDIDOS, BLOQUEIA_MVB, BLQ_VENDA_SEM_IERG, BLQQTDEFI' +
        'SCAL, BLT_ACEITE_DOCTO, '
      
        '   BLT_AGENCIA, BLT_CARTEIRA, BLT_COD_CEDENTE, BLT_CONTA, BLT_CO' +
        'NVENIO, '
      
        '   BLT_DIAS_ABATIMENTO, BLT_DIAS_DESCONTO, BLT_DIAS_MORA_JUROS, ' +
        'BLT_DIAS_PROTESTO, '
      
        '   BLT_DIG_AGENCIA, BLT_DIG_COD_CEDENTE, BLT_DIG_CONTA, BLT_DIR_' +
        'REMESSA, '
      
        '   BLT_DIR_RETORNO, BLT_EMAIL_PORTA, BLT_EMAIL_SENHA, BLT_EMAIL_' +
        'SERVIDOR, '
      
        '   BLT_EMAIL_USER, BLT_INSTRUCAO, BLT_LAYOUT, BLT_LOCAL_PAGTO, B' +
        'LT_MULTA, '
      
        '   BLT_NOSSO_NUM_FIM, BLT_NOSSO_NUM_INI, BLT_NOSSO_NUM_PROX, BLT' +
        '_PCT_ABATIMENTO, '
      
        '   BLT_PCT_DESCONTO, BLT_VLR_IOF, BLT_VLR_OUTRAS_DESP, CAIXA_SIN' +
        'CRONIZADO, '
      
        '   CAMINHO_EXTERNO, CARREGAMENTO_PARCIAL, CARREGAR_ARQUIVOS, CC_' +
        'COFINS, '
      
        '   CC_CSLL, CC_INSS, CC_IRPJ, CC_ISS, CC_PIS, CEP, CH_INFLUENCIA' +
        '_VENDA, '
      
        '   CHM_LOCPROD_INEXISTENTE, CIDADE, CLI_VND_VISTA, CM_AGR, CM_LI' +
        'B_PCT_VD_PRAZO, '
      
        '   CM_LIB_PCT_VD_VISTA, CM_TX_ADMISTRACAO, CM_VDT, CMD_VDT_PCT, ' +
        'CNPJ, COD_BAIRRO, '
      
        '   COD_CIDADE, COD_LOGRADOURO, COFINS, COMISSAO_NORMAL, COMISSAO' +
        '_POR_FAIXA, '
      
        '   CONF_DUPLIC_REC_LANCTO, CONFIG_ACERTO_1, CONFIG_AGR_RECEITA, ' +
        'CONFIG_CARTA_SCPC, '
      
        '   CONFIG_CONVENIO_PDV, CONFIG_COPIA_CHEQUE, CONFIG_CT13, CONFIG' +
        '_MALADIRETA, '
      
        '   CONFIG_NF_GRAF, CONFIG_NF_SERV, CONFIG_OS, CONFIG_RECIBO, CON' +
        'FIG_REQUISICAO, '
      
        '   CONFIG_SERIE_NF, CONFIG_SERIE_ORC_NF, CONTA_CARTAO_CAIXA, CON' +
        'TAGEM_INCREMENTAL, '
      
        '   CONTROLE_PEDIDO_RESTAURANTE, COR_FUNDO_DESELECIONADO, COR_FUN' +
        'DO_SELECIONADO, '
      
        '   CRT_INFLUENCIA_VENDA, CTB_DT_AVISO_BANCARIO, CTB_JUROS_RECEBI' +
        'DOS_REC, '
      
        '   CTR_BASE_INSS_MUN, CTR_BASE_INSS_NAC, CTR_BASE_ISS_MUN, CTR_B' +
        'ASE_ISS_NAC, '
      
        '   CTR_COFINS, CTR_CSLL, CTR_EXIBE_REL_CONSOLIDADO, CTR_EXIBE_RE' +
        'L_PROVISIONADO, '
      
        '   CTR_INSS, CTR_IRPJ, CTR_ISS, CTR_PIS, CUSTO_VARIAVEL, CX_COMP' +
        '_SLD_ANT, '
      
        '   CX_IMP_VND_AGRUPADA, CX_PAGAR_CAIXA, CX_RECEBER_CAIXA, CX_TRA' +
        'NSP_SLD_ANT, '
      
        '   DB_VERSAO, DESC_BX_PARCIAL, DESCONTO_MAXIMO, DESCONTOS, DESP_' +
        'BANCARIA, '
      
        '   DIG_CARTAO_VENDA, DIG_CHEQUE_VENDA, DIG_DESC_VENDA, DIG_ITENS' +
        '_NF, DIG_SENHA_VENDEDOR, '
      
        '   DIG_UNIDADE_VENDA, DIGITA_COTACOES, DIGITA_NUM_NOTA, DIGITA_V' +
        'ENDEDOR_PDV, '
      
        '   DIRETORIO_TEF, DT_CX_MOVTO_ANTERIOR, DT_ULT_VENDA, DUPLICATA,' +
        ' ECF_ULTNUMERO, '
      
        '   EDITA_NUM_NF, ELIMINA_ZERO_PRD_SEM_GRADE, EMAIL, EMAIL_CONTRO' +
        'LE, EMAIL_PADRAO, '
      
        '   EMBUTIR_JUROS_IMPRESSOES, END_NUMERO, ENDERECO, EST_ET_PROD_G' +
        'RD1, EST_ET_PROD_GRD2, '
      
        '   EST_ET_PROD_GRD3, EST_ET_PROD_GRD3_DESCTO, EST_ET_PROD_GRD3_P' +
        'ARC, EST_ET_PROD_GRD4, '
      
        '   EST_MIN_CONTA_EMAIL_ENVIO, EST_MIN_DESTINOS_EMAIL_ENVIO, EST_' +
        'MIN_LOGIN_EMAIL_ENVIO, '
      
        '   EST_MIN_PASSWORD_EMAIL_ENVIO, EST_MIN_SMTP_EMAIL_ENVIO, EXIBE' +
        '_ACERTO_CONTAS, '
      
        '   EXIBE_AGR, EXIBE_CARGA, EXIBE_CB, EXIBE_CTB, EXIBE_CTR_OBRAS,' +
        ' EXIBE_INDICE_PDV, '
      
        '   EXIBE_MESALIDADES, EXIBE_MESAS, EXIBE_MOD, EXIBE_NFE, EXIBE_P' +
        'ENDENCIA, '
      
        '   EXIBE_SINTEGRA, EXIBE_SRV, EXIBE_TBL, EXT_LANC_CAIXA_FECHADO,' +
      ...
      'values'
        ...
        '   :BAIRRO, :BCH_ATIVO, :BCH_AUTO_IMPORTA, :BCH_CONC_CODIGO_PROD' +
        'UTO, :BCH_EXIBE_DESCONTO, '
    ...
    ModifySQL.Strings = (
      ...
      '  AVISO_ESTOQUE_MIN = :AVISO_ESTOQUE_MIN,'
      '  BAIRRO = :BAIRRO,'
      '  BCH_ATIVO = :BCH_ATIVO,'
    ...
    object EmpresasAVISO_ESTOQUE_MIN: TIBStringField
      FieldName = 'AVISO_ESTOQUE_MIN'
      Origin = '"SIS_EMPRESAS"."AVISO_ESTOQUE_MIN"'
      FixedChar = True
      Size = 1
    end
  end
