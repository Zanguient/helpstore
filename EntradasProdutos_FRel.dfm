object FRelEntradasProdutos: TFRelEntradasProdutos
  Left = 257
  Top = 238
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio de Entradas por Produtos'
  ClientHeight = 165
  ClientWidth = 330
  Color = clWhite
  ...
  object rptEntradasProdutos: TppReport
    AutoStop = False
    DataPipeline = pprEntradasProdutos
    ...
    Version = '12.03'
    mmColumnWidth = 0
    DataPipelineName = 'pprEntradasProdutos'
  ...
  object pprEntradasProdutos: TppDBPipeline
    DataSource = dsEntradasProdutos
    UserName = 'rEntradasProdutos'
    Left = 255
    Top = 3
    object pprEntradasProdutosppField1: TppField
      FieldAlias = 'PRODUTO'
      FieldName = 'PRODUTO'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object pprEntradasProdutosppField2: TppField
      FieldAlias = 'QTDE'
      FieldName = 'QTDE'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object pprEntradasProdutosppField3: TppField
    ...
    object pprEntradasProdutosppField4: TppField
      FieldAlias = 'TOTAL'
      FieldName = 'TOTAL'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object dsEntradasProdutos: TDataSource
    AutoEdit = False
    DataSet = DMRelatorios.RelEntradasProdutos
    Left = 290
    Top = 3
  end
