object FRelEntradas: TFRelEntradas
  Left = 258
  Top = 191
  BorderStyle = bsDialog
  Caption = ' Relat'#243'rio de Entradas de Produtos'
  ClientHeight = 287
  ClientWidth = 365
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object cmbTipoRel: TdxPickEdit
      ...
      Style.ButtonStyle = btsSimple
      TabOrder = 4
      OnEnter = cmbTipoRelEnter
      OnExit = cmbTipoRelExit
      OnKeyDown = cmbPessoaKeyDown
    ...
    object cknatureza: TCheckBox
      Left = 175
      Top = 223
      Width = 140
      Height = 17
      Caption = 'Quebra por Natureza'
      Enabled = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 8404992
      Font.Height = -11
  ...
  object dbRelEntSint: TppDBPipeline
    DataSource = dsEntProd
    UserName = 'dbRelEntSint'
    Left = 241
    Top = 4
    object dbRelEntSintppField1: TppField
    ...
    object dbRelEntSintppField2: TppField
      FieldAlias = 'DATA_NF'
      FieldName = 'DATA_NF'
      FieldLength = 0
      DataType = dtDate
    ...
    object dbRelEntSintppField3: TppField
      FieldAlias = 'PRODUTO'
      FieldName = 'PRODUTO'
      FieldLength = 80
      DisplayWidth = 80
    ...
    object dbRelEntSintppField4: TppField
      FieldAlias = 'NUM_NF'
      FieldName = 'NUM_NF'
      FieldLength = 20
      DisplayWidth = 20
    ...
    object dbRelEntSintppField5: TppField
    ...
    object dbRelEntSintppField6: TppField
      Alignment = taRightJustify
    ...
    object dbRelEntSintppField7: TppField
      Alignment = taRightJustify
    ...
    object dbRelEntSintppField8: TppField
      FieldAlias = 'ORIGEM'
      FieldName = 'ORIGEM'
      FieldLength = 3
      DisplayWidth = 3
    ...
    object dbRelEntSintppField9: TppField
      Alignment = taRightJustify
      FieldAlias = 'DESCONTO_NOTA'
    ...
    object dbRelEntSintppField10: TppField
      Alignment = taRightJustify
    ...
    object dbRelEntSintppField11: TppField
      Alignment = taRightJustify
      FieldAlias = 'COD_FORN'
      FieldName = 'COD_FORN'
      FieldLength = 0
    ...
    object dbRelEntSintppField12: TppField
      Alignment = taRightJustify
    ...
    object dbRelEntSintppField13: TppField
      FieldAlias = 'AQUI'
      FieldName = 'AQUI'
      FieldLength = 3
      DisplayWidth = 3
    ...
    object dbRelEntSintppField14: TppField
      Alignment = taRightJustify
      FieldAlias = 'CFOP'
      FieldName = 'CFOP'
      FieldLength = 0
    ...
    object dbRelEntSintppField15: TppField
      FieldAlias = 'NDOC'
      FieldName = 'NDOC'
      FieldLength = 20
      DisplayWidth = 20
  ...
  object dsEntProd: TDataSource
    DataSet = DMRelatorios.qryRelEntProd
    Left = 277
    Top = 4
  end
  ...
  object dsResumo: TDataSource
    DataSet = DMRelatorios.qryRelResEnt
    Left = 281
    Top = 36
  end
