    ...
    object Panel5: TPanel
      ...
      object GRID: TdxDBGrid
        ...
        Bands = <
          ...
          item
            Caption = 'Dados do Registro de Contas '#224' Receber'
          end>
        DefaultLayout = False
        ...
        object GRIDNUM_CF: TdxDBGridMaskColumn
          BandIndex = 0
          RowIndex = 0
          FieldName = 'NUM_CF'
        end
        ...
        object GRIDVLR_BAIXA: TdxDBGridMaskColumn
          Width = 118
          BandIndex = 0
          RowIndex = 0
          FieldName = 'VLR_BAIXA'
        ...
        object GRIDCODIGO_VN: TdxDBGridMaskColumn
          Width = 73
          BandIndex = 1
          RowIndex = 0
          FieldName = 'CODIGO_VN'
        ...
        object GRIDVLR_PARCIAL: TdxDBGridMaskColumn
          Width = 118
          BandIndex = 1
          RowIndex = 0
        ...
        object GRIDDT_AVISO: TdxDBGridDateColumn
          Width = 73
          BandIndex = 0
          RowIndex = 0
          FieldName = 'DT_AVISO'
        end
        object GRIDNUMDUPLICATA: TdxDBGridMaskColumn
          Width = 73
          BandIndex = 1
          RowIndex = 0
        ...
        object GRIDIDX_COTACAO: TdxDBGridCurrencyColumn
          Width = 118
          BandIndex = 0
          RowIndex = 0
        ...
        object GRIDIDX_QTDE: TdxDBGridCurrencyColumn
          Width = 118
          BandIndex = 0
          RowIndex = 0
          FieldName = 'IDX_QTDE'
