...
procedure TFrmFabricantes.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  //
  If FrmFabricantes.FormStyle = fsMDIChild Then
     Begin
...
procedure TFrmFabricantes.ActIncluirExecute(Sender: TObject);
begin
...
procedure TFrmFabricantes.ActExcluirExecute(Sender: TObject);
begin
...
procedure TFrmFabricantes.ActPostExecute(Sender: TObject);
begin
  Try
...
procedure TFrmFabricantes.ActCancelExecute(Sender: TObject);
begin
...
procedure TFrmFabricantes.ActListagemExecute(Sender: TObject);
begin
  //
...
procedure TFrmFabricantes.ActLocalizarExecute(Sender: TObject);
begin
  try
...
procedure TFrmFabricantes.dxDBEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmFabricantes.pnlClientResize(Sender: TObject);
begin
  b2.Width := pnlClient.Width - 17;
  LblRegistros.Left := pnlClient.Width - 11 - LblRegistros.Width;
end;

procedure TFrmFabricantes.DataSourceStateChange(Sender: TObject);
begin
  If DataSource.State in dsEditModes Then
     Begin
...
procedure TFrmFabricantes.ActFecharExecute(Sender: TObject);
begin
  If FrmFabricantes.FormStyle = fsMDIChild Then
...
procedure TFrmFabricantes.DataSourceDataChange(Sender: TObject; Field: TField);
begin
