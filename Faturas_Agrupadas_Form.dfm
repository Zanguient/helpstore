object FrmFaturas_Notas: TFrmFaturas_Notas
  Left = 91
  Top = 93
  Width = 562
  Height = 388
  BorderIcons = [biMinimize, biMaximize]
  Caption = 'Notas Agrupadas'
  Color = clBtnFace
  ...
  object pnlClient: TPanel
    ...
    object GRID: TdxDBGrid
      ...
      OptionsDB = [edgoCancelOnExit, edgoCanNavigation, edgoPartialLoad, edgoUseBookmarks]
    ...
    object Panel1: TPanel
      ...
      object RxLabel1: TcxLabel
        Left = 8
        Top = 10
        Caption = '( F9 ) Efetua a Troca Fiscal do Produto'
        ParentFont = False
        Transparent = True
      end
  ...
  object Actions: TActionList
    ...
    object ActTrocarProd: TAction
      Caption = 'Trocar Produto Fiscal'
      ShortCut = 120
      OnExecute = ActTrocarProdExecute
    end
  end
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DmVendas.SelFatura_Futura_Prod
    Left = 387
    Top = 119
  end
  object stgFrmFaturas_Notas: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrmFaturas_Notas'
    Left = 160
    Top = 263
  end
end
