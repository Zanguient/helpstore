object FrmGrades: TFrmGrades
  ...
  object pnlClient: TPanel
    ...
    object Panel4: TPanel
      ...
      object gridNumeros: TDBGrid
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgRowLines, dgTabs, dgCancelOnExit]
        ParentFont = False
        TabOrder = 3
        TitleFont.Charset = DEFAULT_CHARSET
    ...
    object CmbPerfil: TdxDBLookupEdit
      Left = 75
      Top = 123
      Width = 246
      Font.Charset = DEFAULT_CHARSET
  ...
  object Actions: TActionList
    ...
    object ActNumero: TAction
      Tag = 1
      Caption = 'Novo N'#250'mero'
      OnExecute = ActNumeroExecute
    end
  end
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Grades
  ...
  object DsNumeros: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.GRADES_NUMEROS
    Left = 189
    Top = 288
  end
end
