object FrmIncluirNotaFatura: TFrmIncluirNotaFatura
  Left = 227
  Top = 107
  Width = 562
  Height = 388
  BorderIcons = [biMinimize, biMaximize]
  Caption = 'Incluir Nota na Fatura'
  Color = clBtnFace
  ...
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DmVendas.SelFatura_Futura
    Left = 387
    Top = 119
  end
  object stgFrmIncluirNotaFatura: TcxPropertiesStore
    Components = <
      item
        Component = ActFechar
        Properties.Strings = (
    ...
    StorageName = 'stgFrmIncluirNotaFatura'
    Left = 152
    Top = 223
  end
end
