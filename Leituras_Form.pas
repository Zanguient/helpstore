...
begin
  with dmCadastros2 do
   begin
    ...
    AuxSql := 'select grp.codigo from ofc_grp_contratos grp where grp.ativo = ''S'' and grp.codigo = ' + LeituraCONTRATO.AsString
          + ' and cast(grp.dt_fim as date) < ( select cast(data as date) from data_servidor)';
