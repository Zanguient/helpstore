object FRelListaPrecosUnid: TFRelListaPrecosUnid
  Left = 252
  Top = 161
  BorderStyle = bsDialog
  Caption = ' Listagem de Pre'#231'os por Unidade'
  ClientHeight = 299
  ClientWidth = 365
  Color = clWhite
  ...
  object stgFRelListaPrecosUnid: TcxPropertiesStore
    Components = <
      item
        Component = ActBuscarProd
        Properties.Strings = (
          'Caption'
          'Category'
          'Checked'
    ...
    StorageName = 'stgFRelListaPrecosUnid'
    Left = 256
    Top = 144
  end
end
