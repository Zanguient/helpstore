...
{  If DMCadastros.Tag = 0 Then
     ...
     End;}
  //
  If FrmLocalizacao.FormStyle = fsMDIChild Then
...
procedure TFrmLocalizacao.ActIncluirExecute(Sender: TObject);
begin
...
procedure TFrmLocalizacao.ActExcluirExecute(Sender: TObject);
begin
...
procedure TFrmLocalizacao.ActPostExecute(Sender: TObject);
begin
  Try
...
procedure TFrmLocalizacao.ActCancelExecute(Sender: TObject);
begin
...
procedure TFrmLocalizacao.ActListagemExecute(Sender: TObject);
begin
  //
...
procedure TFrmLocalizacao.ActLocalizarExecute(Sender: TObject);
begin
  try
        ...
        Frm_Localizar_Generico.LblTitulo.Caption := 'Localizar Bairros' ;
...
procedure TFrmLocalizacao.dxDBEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmLocalizacao.pnlClientResize(Sender: TObject);
begin
  b2.Width := pnlClient.Width - 17;
  LblRegistros.Left := pnlClient.Width - 11 - LblRegistros.Width;
end;

procedure TFrmLocalizacao.DataSourceStateChange(Sender: TObject);
begin
  If DataSource.State in dsEditModes Then
     Begin
...
procedure TFrmLocalizacao.ActFecharExecute(Sender: TObject);
begin
  If FrmLocalizacao.FormStyle = fsMDIChild Then
...
procedure TFrmLocalizacao.DataSourceDataChange(Sender: TObject; Field: TField);
begin
  LblRegistros.Caption := IntToStr(Datasource.DataSet.Recno) + '/' + IntToStr(Datasource.Dataset.RecordCount); 
end;

procedure TFrmLocalizacao.ActAlterarExecute(Sender: TObject);
begin
  If DataSource.State in dsEditModes Then
     Exit;
  Try
...
procedure TFrmLocalizacao.EdInicialEnter(Sender: TObject);
begin
     CORFUNDO ( SENDER );
end;

procedure TFrmLocalizacao.EdInicialExit(Sender: TObject);
begin
     TIRACORFUNDO ( SENDER );
end;
