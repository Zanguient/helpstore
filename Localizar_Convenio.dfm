object Frm_Localizar_Convenios: TFrm_Localizar_Convenios
  Left = 239
  Top = 139
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Localizar Conv'#234'niados'
      ParentFont = False
      Transparent = True
    end
  ...
  object stgFrm_Localizar_Convenios: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Convenios'
    Left = 368
    Top = 120
  end
end
