object FrmLocFaturas: TFrmLocFaturas
  Left = 178
  Top = 102
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Localizar Faturas'
  ClientHeight = 444
  ClientWidth = 620
  Color = clBtnFace
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.Manutencao_Fatura
    Left = 272
    Top = 168
  end
  object stgFrmLocFaturas: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
