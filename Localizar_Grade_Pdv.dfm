object Frm_Localizar_Grades_Pdv: TFrm_Localizar_Grades_Pdv
  Left = 200
  Top = 133
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmPdv.Lista_Grades
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Grades_Pdv: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Grades_Pdv'
    Left = 186
    Top = 130
  end
end
