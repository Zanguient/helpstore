object Frm_Localizar_Lote: TFrm_Localizar_Lote
  Left = 150
  Top = 255
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Localizar Lotes '
  ClientHeight = 319
  ClientWidth = 618
  Color = clBtnFace
  ...
  object pnlClient: TPanel
    ...
    object GRID: TdxDBGrid
      ...
      object GRIDLOTE: TdxDBGridMaskColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'LOTE'
      end
      object GRIDPENEIRA: TdxDBGridMaskColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'PENEIRA'
      end
      ...
      object GRIDATESTADO: TdxDBGridMaskColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'ATESTADO'
      end
      object GRIDGERMINACAO: TdxDBGridMaskColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'GERMINACAO'
      end
      object GRIDPUREZA: TdxDBGridMaskColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'PUREZA'
      end
      ...
      object GRIDULT_COMPRA: TdxDBGridColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'DT_ULTIMA_COMPRA'
      end
      object GRIDULT_VENDA: TdxDBGridColumn
        BandIndex = 0
        RowIndex = 0
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DMEntradas.SelLote
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Lote: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Lote'
    Left = 224
    Top = 120
  end
end
