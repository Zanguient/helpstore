object Frm_Localizar_Mecanicos: TFrm_Localizar_Mecanicos
  Left = 192
  Top = 121
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Mec'#226'nicos'
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object stgFrm_Localizar_Mecanicos: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Mecanicos'
    Left = 168
    Top = 120
  end
end
