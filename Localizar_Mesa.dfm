object Frm_Localizar_Mesas: TFrm_Localizar_Mesas
  Left = 213
  Top = 129
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Localizar Mesas'
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmPdv.SelMesasPdv
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Mesas: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Mesas'
    Left = 184
    Top = 176
  end
end
