object Frm_Localizar_Motor: TFrm_Localizar_Motor
  Left = 186
  Top = 119
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Equipamentos'
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object stgFrm_Localizar_Motor: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Motor'
    Left = 192
    Top = 112
  end
end
