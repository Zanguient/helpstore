object Frm_Localizar_Natureza: TFrm_Localizar_Natureza
  Left = 304
  Top = 154
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Naturezas '
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object stgLocalizarNatOperacao: TcxPropertiesStore
    Components = <
      item
    ...
    StorageName = 'stgLocalizarNatOperacao'
    Left = 176
    Top = 128
  end
end
