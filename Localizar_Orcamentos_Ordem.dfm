object FrmLocOrcamentos_Ordem: TFrmLocOrcamentos_Ordem
  Left = 87
  Top = 70
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmServicos.SelOrdens_Servicos_Orc
    Left = 272
    Top = 168
  end
  object stgFrmLocOrcamentos_Ordem: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrmLocOrcamentos_Ordem'
    Left = 240
    Top = 232
  end
end
