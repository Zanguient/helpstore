object Frm_Lista_Precos_Servicos: TFrm_Lista_Precos_Servicos
  Left = 156
  Top = 118
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Lista de Pre'#231'os de Servi'#231'os'
      ParentFont = False
      Transparent = True
    end
    ...
    object GRID: TdxDBGrid
      ...
      object GRIDATIVO: TdxDBGridMaskColumn
        Width = 30
        BandIndex = 0
        RowIndex = 0
        FieldName = 'ATIVO'
    ...
    object GRIDMOTOR: TdxDBGrid
      ...
      PreviewFont.Name = 'MS Sans Serif'
      PreviewFont.Style = []
      OnChangeNode = GRIDMOTORChangeNode
      ...
      object GRIDMOTORCILINDROS: TdxDBGridMaskColumn
        Width = 76
        BandIndex = 0
        RowIndex = 0
        FieldName = 'CILINDROS'
      end
      object GRIDMOTORCOMBUSTIVEL: TdxDBGridMaskColumn
        Width = 88
        BandIndex = 0
        RowIndex = 0
        FieldName = 'COMBUSTIVEL'
      end
      object GRIDMOTORTIPO: TdxDBGridMaskColumn
        Width = 40
        BandIndex = 0
        RowIndex = 0
        FieldName = 'TIPO'
  ...
  object stgFrm_Lista_Precos_Servicos: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
      ...
      item
        Component = GRIDMOTORCOMBUSTIVEL
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
    ...
    StorageName = 'stgFrm_Lista_Precos_Servicos'
    Left = 152
    Top = 240
  end
end
