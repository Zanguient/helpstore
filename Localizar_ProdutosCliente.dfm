object FrmLocProdutoClientes: TFrmLocProdutoClientes
  Left = 171
  Top = 138
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Localizar Contratos Produto/Cliente'
  ClientHeight = 406
  ClientWidth = 785
  Color = clBtnFace
  ...
  object pnlClient: TPanel
    ...
    object GRID: TdxDBGrid
      ...
      PreviewFont.Style = []
      object GRIDCODIGO_NOME: TdxDBGridMaskColumn
        Visible = False
        Width = 222
        BandIndex = 0
        RowIndex = 0
  ...
  object stgFrmLocProdutoClientes: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrmLocProdutoClientes'
    Left = 192
    Top = 176
  end
end
