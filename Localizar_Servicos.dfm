object Frm_Localizar_Servico: TFrm_Localizar_Servico
  Left = 514
  Top = 275
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmServicos.SelServicos
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Servico: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Servico'
    Left = 152
    Top = 216
  end
end
