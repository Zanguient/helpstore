object Frm_Localizar_Terceiros: TFrm_Localizar_Terceiros
  Left = 146
  Top = 133
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Terceiros '
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object stgFrm_Localizar_Terceiros: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Terceiros'
    Left = 200
    Top = 120
  end
end
