object Frm_Localizar_Transportadoras: TFrm_Localizar_Transportadoras
  Left = 146
  Top = 133
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Transportadoras'
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object stgFrm_Localizar_Transportadoras: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Transportadoras'
    Left = 216
    Top = 128
  end
end
