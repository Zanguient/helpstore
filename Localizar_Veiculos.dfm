object Frm_Localizar_Veiculos: TFrm_Localizar_Veiculos
  Left = 186
  Top = 119
  ...
  object pnlClient: TPanel
    ...
    object GRID: TdxDBGrid
      ...
      object GRIDMOTORISTA: TdxDBGridColumn
        Visible = False
        Width = 225
        BandIndex = 0
        RowIndex = 0
      ...
      object GRIDKM_ATUAL: TdxDBGridMaskColumn
        Visible = False
        Width = 76
        BandIndex = 0
        RowIndex = 0
      ...
      object GRIDNOME_TIPO: TdxDBGridMaskColumn
        Width = 109
        BandIndex = 0
        RowIndex = 0
        FieldName = 'NOME_TIPO'
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmVendas.SelVeiculos
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Veiculos: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Veiculos'
    Left = 200
    Top = 136
  end
end
