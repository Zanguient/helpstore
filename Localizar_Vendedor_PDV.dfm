object Frm_Localizar_Vendedor: TFrm_Localizar_Vendedor
  Left = 213
  Top = 129
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmPdv.SelVendedorPdv
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Vendedor: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Vendedor'
    Left = 184
    Top = 184
  end
end
