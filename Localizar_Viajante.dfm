object Frm_Localizar_Viajante: TFrm_Localizar_Viajante
  Left = 255
  Top = 115
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSingle
  Caption = ' Localizar Viajantes'
  ClientHeight = 319
  ClientWidth = 534
  Color = clBtnFace
  ...
  object DSource: TDataSource
    AutoEdit = False
    DataSet = DmServicos.SelViajante
    Left = 288
    Top = 136
  end
  object stgFrm_Localizar_Viajante: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrm_Localizar_Viajante'
    Left = 144
    Top = 128
  end
end
