object FrmLog: TFrmLog
  ...
  Caption = 'Log de Transa'#231#245'es'
  ClientHeight = 460
  ClientWidth = 621
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object Panel3: TPanel
      ...
      object GRID: TdxDBGrid
        ...
        object GRIDHORA: TdxDBGridTimeColumn
          BandIndex = 0
          RowIndex = 0
          FieldName = 'HORA'
        end
  ...
  object BarManager: TdxBarManager
    ...
    object BarManagerBar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          Visible = True
          ItemName = 'btnExportarHtml'
        end
        item
          Visible = True
          ItemName = 'btnExportarExcel'
        end
        item
          Visible = True
          ItemName = 'BtnFechar'
    ...
    object btnExportarHtml: TdxBarButton
      Action = ActExportarHtml
      Category = 0
    end
    object btnExportarExcel: TdxBarButton
  ...
  object stgLogTransacao: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
