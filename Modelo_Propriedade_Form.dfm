object FrmModelos_Propriedades: TFrmModelos_Propriedades
  Left = 134
  Top = 227
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = ' Modelos de Propriedade'
  ClientHeight = 141
  ClientWidth = 429
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Modelos de Propriedades'
      ParentFont = False
      Transparent = True
    end
  ...
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Modelo_Propriedade
