object FrmMontaCargas: TFrmMontaCargas
  Left = 103
  Top = 62
  Width = 656
  Height = 510
  BorderIcons = [biSystemMenu]
  Caption = ' Montagem de Cargas '
  Color = clBtnFace
  ...
  object pnlClient: TPanel
    ...
    object pc: TcxPageControl
      ...
      object dxTabSheet1: TcxTabSheet
        ...
        object cmbMotorista: TdxDBLookupEdit
          Left = 187
          Top = 7
          Width = 380
          Font.Charset = DEFAULT_CHARSET
          ...
          Style.Shadow = False
          TabOrder = 1
          OnEnter = cmbMotoristaEnter
          OnExit = cmbMotoristaExit
          OnKeyDown = EdCodigoKeyDown
          DataField = 'MOTORISTA'
          DataSource = DataSource
          ReadOnly = False
        ...
        object edKmSaida: TdxDBCalcEdit
          Left = 59
          Top = 57
          Width = 94
          Font.Charset = DEFAULT_CHARSET
        ...
        object cmbVeiculo: TdxDBLookupEdit
          Left = 127
          Top = 32
          Width = 154
          Font.Charset = DEFAULT_CHARSET
        ...
        object cmbRota: TdxDBLookupEdit
          Left = 339
          Top = 32
          Width = 228
          Font.Charset = DEFAULT_CHARSET
        ...
        object edDtSaida: TdxDBDateEdit
          Left = 204
          Top = 57
          Width = 102
          Font.Charset = DEFAULT_CHARSET
      ...
      object dxTabSheet2: TcxTabSheet
        Caption = 'Notas da Carga'
        object GRIDCARREGADAS: TdxDBGrid
          Left = 6
          Top = 8
          Width = 611
          Height = 337
          ...
          PreviewFont.Name = 'MS Sans Serif'
          PreviewFont.Style = []
          object GRID2CODIGO: TdxDBGridMaskColumn
            Width = 41
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CODIGO'
          end
          object GRID2DATA: TdxDBGridDateColumn
            Width = 79
            BandIndex = 0
            RowIndex = 0
            FieldName = 'DATA'
          end
          object GRID2NOME: TdxDBGridMaskColumn
            Width = 304
            BandIndex = 0
            RowIndex = 0
            FieldName = 'NOME'
          end
          object GRID2FECHADA: TdxDBGridMaskColumn
            Width = 48
            BandIndex = 0
            RowIndex = 0
            FieldName = 'FECHADA'
          end
          object GRID2PESSOA_FJ: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PESSOA_FJ'
          end
          object GRID2NUM_NF: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'NUM_NF'
          end
          object GRID2DESC_ACRES: TdxDBGridMaskColumn
            Width = 69
            BandIndex = 0
            RowIndex = 0
            FieldName = 'DESC_ACRES'
          end
          object GRID2TOTAL: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'TOTAL'
          end
          object GRID2VOLUME: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'VOLUME'
          end
          object GRID2PESO: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PESO'
          end
          object GRID2ORCAMENTO: TdxDBGridMaskColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'ORCAMENTO'
          end
  ...
  object BarMgr: TdxBarManager
    ...
    object OpCarregar: TdxBarButton
      Action = ActCarregarAbertas
      Caption = 'Notas em Aberto ( F9 )'
      Category = 0
    end
    object OpRomaneio: TdxBarButton
      Action = ActRomaneio
      Caption = 'Emitir Romaneio ( F12 )'
      Category = 0
    end
  ...
  object Actions: TActionList
    ...
    object ActCarregarAbertas: TAction
      Caption = 'Carregar'
      ShortCut = 120
      OnExecute = ActCarregarAbertasExecute
    end
    object ActCarregar: TAction
      Caption = 'Carregar ( F10 )'
      ShortCut = 118
      OnExecute = ActCarregarExecute
    end
    object ActPgdn: TAction
      Caption = 'Troca P'#225'gina'
      ShortCut = 16418
  ...
  object dsMotoristas: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Motoristas
    Left = 448
    Top = 19
  end
  object DataSource: TDataSource
    DataSet = DMCadastros.Cargas
  ...
  object dsVeiculos: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Veiculos
    Left = 568
    Top = 24
  end
  object dsRotas: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Rotas
    Left = 504
    Top = 24
  end
  object DsAbertas: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.Faturas_Carregar
    Left = 192
    Top = 191
  end
  object DsFechadas: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.Faturas_Carregadas
    Left = 264
    Top = 191
  end
  object stgFrmMontaCargas: TcxPropertiesStore
    Components = <
      item
