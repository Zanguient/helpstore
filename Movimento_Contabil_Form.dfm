object FrmMov_Contabil: TFrmMov_Contabil
  Left = 242
  Top = 87
  ...
  object pnlClient: TPanel
    ...
    object PAG: TcxPageControl
      ...
      object TAB1: TcxTabSheet
        ...
        object EdDebito: TdxDBButtonEdit
          Left = 119
          Top = 179
          Width = 86
          Font.Charset = DEFAULT_CHARSET
          ...
          ClickKey = 40
          OnButtonClick = EdDebitoButtonClick
          ExistButtons = True
        end
        object EdCredito: TdxDBButtonEdit
          Left = 119
          Top = 153
          Width = 86
          Font.Charset = DEFAULT_CHARSET
          ...
          ClickKey = 40
          OnButtonClick = EdCreditoButtonClick
          ExistButtons = True
        end
      ...
      object TAB2: TcxTabSheet
        ...
        object GRID: TdxDBGrid
          ...
          object GRIDEEXCLUIR: TdxDBGridColumn
            Width = 29
            BandIndex = 0
            RowIndex = 0
            FieldName = 'EXCLUIR'
          ...
          object GRIDCONTRA_PARTIDA: TdxDBGridMaskColumn
            Width = 104
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CONTRA_PARTIDA'
          end
          object GRIDConta_C: TdxDBGridLookupColumn
            Width = 304
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CREDITO'
          end
          object GRIDConta_D: TdxDBGridLookupColumn
            Width = 304
            BandIndex = 0
            RowIndex = 0
            FieldName = 'DEBITO'
          end
          object GRIDCCODIGO_CONTABIL: TdxDBGridColumn
            Caption = 'C'#243'digo'
            Width = 94
            BandIndex = 0
            RowIndex = 0
  ...
  object BarManager: TdxBarManager
    ...
    object OpMarcar: TdxBarButton
      Caption = 'Marcar para Exclus'#227'o ( F9 )'
      Category = 0
      Hint = 'Marcar para Exclus'#227'o ( F9 )'
      Visible = ivAlways
    end
  ...
  object DataSource: TDataSource
    DataSet = DMCadastros.Movimento_Contabil
  ...
  object DsMovimento: TDataSource
    DataSet = DmPlano.Movimento
    OnStateChange = DataSourceStateChange
    OnDataChange = DataSourceDataChange
    Left = 506
    Top = 336
  end
  object stgFrmMov_Contabil: TcxPropertiesStore
    Components = <
      item
        Component = ActAltera
        Properties.Strings = (
      ...
      item
        Component = GRIDCCODIGO_CONTABIL
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
    ...
    StorageName = 'stgFrmMov_Contabil'
    Left = 568
    Top = 255
  end
end
