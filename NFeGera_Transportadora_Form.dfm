object frmNFeGeraTransportadora: TfrmNFeGeraTransportadora
  Left = 264
  Top = 161
  BorderStyle = bsDialog
  Caption = 'NFe - Exportar Registros de Transportadoras'
  ClientHeight = 236
  ClientWidth = 443
  Color = clWhite
  ...
  object qryNFeTransportadoras: TIBQuery
    Database = DmApp.Database
    Transaction = DmApp.Transaction
    SQL.Strings = (
      'select * from NFE_TRANSPORTADORA(:cnpj,:codigo)')
    Left = 128
    Top = 8
    ParamData = <
      item
    ...
    object qryNFeTransportadorasTRANSPORTADORA: TIBStringField
      FieldName = 'TRANSPORTADORA'
      Origin = '"NFE_TRANSPORTADORA"."TRANSPORTADORA"'
      Size = 500
    end
  end
  object DataSource: TDataSource
    DataSet = FrmNFeManutencao.mtbTransportadora
    Left = 189
    Top = 7
  end
end
