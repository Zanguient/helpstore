object FrmPerfilComissao: TFrmPerfilComissao
  Left = 198
  Top = 120
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Perfis de Comiss'#227'o'
  ClientHeight = 522
  ClientWidth = 696
  Color = clWhite
  ...
  object Panel1: TPanel
    ...
    object pc: TcxPageControl
      ...
      object dxTabSheet1: TcxTabSheet
        ...
        object cmbBase: TcxDBComboBox
          Left = 8
          Top = 72
          DataBinding.DataField = 'BASE_CALC'
      ...
      object tbsFaixas: TcxTabSheet
        ...
        object RxLabel3: TcxLabel
          Left = 224
          Top = 235
          Caption = 'Comiss'#227'o por Produto'
          ParentFont = False
          Transparent = True
          OnClick = ActCancelarExecute
        end
        object GridVlr: TdxDBGrid
          Left = 9
          Top = 69
          Width = 288
          Height = 143
          ...
          BandFont.Style = []
          DataSource = dmFinanceiro2.dsLinkPerfilFx
          ...
          PreviewFont.Style = []
          ScrollBars = ssNone
          object GridVlrCNPJ: TdxDBGridMaskColumn
            Visible = False
            Width = 77
            BandIndex = 0
            RowIndex = 0
          ...
          object GridVlrCODIGO: TdxDBGridMaskColumn
          ...
          object GridVlrCOD_PERFIL: TdxDBGridMaskColumn
            Visible = False
            Width = 59
            BandIndex = 0
            RowIndex = 0
          ...
          object GridVlrVLR_INICIAL: TdxDBGridColumn
          ...
          object GridVlrVLR_FINAL: TdxDBGridColumn
            Width = 66
            BandIndex = 0
            RowIndex = 0
            FieldName = 'VLR_FINAL'
        ...
        object GridDescto: TdxDBGrid
          ...
          BandFont.Name = 'Tahoma'
          BandFont.Style = []
          DataSource = dmFinanceiro2.dsLinkPerfilDesc
          Filter.Criteria = {00000000}
          ...
          PreviewFont.Style = []
          ScrollBars = ssNone
          object GridDesctoCNPJ: TdxDBGridMaskColumn
            Visible = False
            Width = 76
            BandIndex = 0
            RowIndex = 0
          ...
          object GridDesctoCODIGO: TdxDBGridMaskColumn
            Color = clInactiveCaption
            TabStop = False
            Width = 47
            BandIndex = 0
          ...
          object GridDesctoPCT_INICIAL: TdxDBGridColumn
            Color = clInactiveBorder
            ReadOnly = True
            TabStop = False
            BandIndex = 0
          ...
          object GridDesctoPCT_FINAL: TdxDBGridColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PCT_FINAL'
          end
          object GridDesctoPCT_VISTA: TdxDBGridColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PCT_VISTA'
          end
          object GridDesctoPCT_PRAZO: TdxDBGridColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PCT_PRAZO'
          end
          object GridDesctoCOD_PERFIL_FAIXA: TdxDBGridMaskColumn
            Caption = ' '
            Color = clYellow
            TabStop = False
            Width = 34
        ...
        object GridProd: TdxDBGrid
          ...
          PreviewFont.Style = []
          ScrollBars = ssNone
          object GridProdCODIGO: TdxDBGridMaskColumn
            Color = clInactiveCaption
            ReadOnly = True
            TabStop = False
            Width = 50
          ...
          object GridProdCNPJ: TdxDBGridMaskColumn
            Visible = False
            Width = 76
            BandIndex = 0
            RowIndex = 0
          ...
          object GridProdCOD_PRODUTO: TdxDBGridMaskColumn
            Caption = 'Produto'
            Width = 55
            BandIndex = 0
            RowIndex = 0
          ...
          object GridProdNOME: TdxDBGridMaskColumn
            Color = clMenu
            ReadOnly = True
            TabStop = False
            Width = 184
          ...
          object GridProdPCT_PROD_VISTA: TdxDBGridColumn
            Width = 67
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PCT_PROD_VISTA'
          end
          object GridProdPCT_PROD_PRAZO: TdxDBGridColumn
            Width = 73
            BandIndex = 0
            RowIndex = 0
            FieldName = 'PCT_PROD_PRAZO'
          end
          object GridProdCOD_PERFIL_FX_DESC: TdxDBGridMaskColumn
            Caption = ' '
            Color = clYellow
            ReadOnly = True
            TabStop = False
  ...
  object dsPerfil: TDataSource
    DataSet = dmFinanceiro2.COM_PERFIL
  ...
  object dsProdutos: TDataSource
    DataSet = dmFinanceiro2.CM_PERFIL_FAIXA_PROD
    OnStateChange = dsPerfilStateChange
    Left = 436
    Top = 177
  end
  object lstProdutos: TDataSource
    DataSet = DMCadastros.Produtos
    OnStateChange = dsPerfilStateChange
    Left = 436
    Top = 217
  end
  object stgFrmPerfilComissao: TcxPropertiesStore
    Components = <
      item
        Properties.Strings = (
          'Action'
      ...
      item
        Component = GridDesctoCOD_PERFIL_FAIXA
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
      ...
      item
        Component = GridDesctoPCT_INICIAL
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
      ...
      item
        Component = GridProdCOD_PERFIL_FX_DESC
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
      ...
      item
        Component = GridProdPCT_PROD_PRAZO
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
      ...
      item
        Component = GridProdPCT_PROD_VISTA
        Properties.Strings = (
          'Alignment'
          'BandIndex'
          'Caption'
    ...
    StorageName = 'stgFrmPerfilComissao'
    Left = 144
    Top = 215
  end
end
