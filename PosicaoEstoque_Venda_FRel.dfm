object FRelPosicaoEstoqueVenda: TFRelPosicaoEstoqueVenda
  Left = 273
  Top = 149
  BorderStyle = bsDialog
  Caption = ' Listagem de Posi'#231#227'o de Estoque'
  ClientHeight = 264
  ClientWidth = 353
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object ckGerar: TCheckBox
      Left = 190
      Top = 197
      Width = 147
      Height = 17
      Caption = 'Gerar c:\Posicao.txt '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 8404992
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object Print: TRDprint
    ...
    OnNewPage = Print2NewPage
    OnBeforeNewPage = Print2BeforeNewPage
    Left = 312
    Top = 24
  end
end
