...
procedure TFrmPragas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  //
  If FrmPragas.FormStyle = fsMDIChild Then
  Begin
...
procedure TFrmPragas.ActIncluirExecute(Sender: TObject);
begin
...
procedure TFrmPragas.ActExcluirExecute(Sender: TObject);
begin
...
procedure TFrmPragas.ActPostExecute(Sender: TObject);
begin
  Try
...
procedure TFrmPragas.ActCancelExecute(Sender: TObject);
begin
...
procedure TFrmPragas.FormCreate(Sender: TObject);
begin
  //
...
procedure TFrmPragas.ActListagemExecute(Sender: TObject);
begin
  //
...
procedure TFrmPragas.ActLocalizarExecute(Sender: TObject);
begin
  try
...
procedure TFrmPragas.dxDBEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPragas.pnlClientResize(Sender: TObject);
begin
  b2.Width := pnlClient.Width - 17;
  LblRegistros.Left := pnlClient.Width - 11 - LblRegistros.Width;
end;

procedure TFrmPragas.DataSourceStateChange(Sender: TObject);
begin
  If DataSource.State in dsEditModes Then
     Begin
...
procedure TFrmPragas.ActFecharExecute(Sender: TObject);
begin
  If FrmPragas.FormStyle = fsMDIChild Then
...
procedure TFrmPragas.DataSourceDataChange(Sender: TObject; Field: TField);
begin
