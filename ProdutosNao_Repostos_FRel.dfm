object FRelProdutosNaoRepostos: TFRelProdutosNaoRepostos
  Left = 248
  Top = 153
  BorderStyle = bsDialog
  Caption = 'Rel. de Produtos N'#227'o Repostos a N Dias'
  ClientHeight = 143
  ClientWidth = 482
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Produtos Sem Reposi'#231#227'o'
      ParentFont = False
      Transparent = True
    end
    object Ini: TdxCurrencyEdit
      Left = 150
      Top = 61
      Width = 43
      Font.Charset = DEFAULT_CHARSET
