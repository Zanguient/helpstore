object FrmProdutos_Aplicacoes: TFrmProdutos_Aplicacoes
  Left = 232
  Top = 115
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Aplica'#231#245'es dos Produtos'
      ParentFont = False
      Transparent = True
    end
    ...
    object EdInicial: TdxDBEdit
      ...
      OnExit = cmbAplicacaoExit
      OnKeyDown = EdProdutoKeyDown
      CharCase = ecUpperCase
      DataField = 'LOCAL'
      DataSource = DataSource
    end
    object cmbAplicacao: TdxDBLookupEdit
      Left = 120
      Top = 77
      Width = 294
      Font.Charset = DEFAULT_CHARSET
  ...
  object Actions: TActionList
    ...
    object ActF4Aplicacao: TAction
      ShortCut = 115
      OnExecute = ActF4AplicacaoExecute
    end
  end
  object DataSource: TDataSource
    DataSet = DMCadastros.Produtos_Aplicacoes
  ...
  object DsAplicacoes: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Aplicacoes
    Left = 501
    Top = 240
  end
end
