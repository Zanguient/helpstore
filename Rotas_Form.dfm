object FrmRotas: TFrmRotas
    ...
    object pc: TcxPageControl
      ...
      object dxTabSheet1: TcxTabSheet
        ...
        object BtnCidades: TcxButton
          ...
          Cursor = crHandPoint
          Action = ActIncCidade
          Caption = 'Cadastrar Cidades Inexistentes ( F8 )'
          TabOrder = 11
          Glyph.Data = {
            06030000424D06030000000000003600000028000000100000000F0000000100
            180000000000D0020000C30E0000C30E00000000000000000000BFBFBFBFBFBF
  ...
  object Actions: TActionList
    ...
    object ActIncCidade: TAction
      OnExecute = ActIncCidadeExecute
    end
    object ActDelCidade: TAction
      OnExecute = ActDelCidadeExecute
    end
    object ActNovaCidade: TAction
      Caption = 'Nova Cidade'
      ShortCut = 119
      OnExecute = ActNovaCidadeExecute
    end
  end
  object dsRotasCidades: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.Rotas_Cidades
    Left = 368
    Top = 195
  end
  ...
  object dsCidades: TDataSource
    AutoEdit = False
    DataSet = DMCadastros.SelCidades
    Left = 448
    Top = 194
  end
