object FrmSelVendasCanceladas: TFrmSelVendasCanceladas
  Left = 164
  Top = 100
  Width = 637
  Height = 472
  ...
  object stgFrmSelVendasCanceladas: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrmSelVendasCanceladas'
    Left = 440
    Top = 186
  end
end
