object FrmSeriesCustomizaveis: TFrmSeriesCustomizaveis
  ...
  object QryOS: TIBQuery
    ...
    object QryOSOS_TROCA_CILINDRO: TIBStringField
      FieldName = 'OS_TROCA_CILINDRO'
      Origin = '"PCD_IMPRIME_OS"."OS_TROCA_CILINDRO"'
      FixedChar = True
      Size = 1
    end
    object QryOSOS_TROCA_FUSAO: TIBStringField
      FieldName = 'OS_TROCA_FUSAO'
      Origin = '"PCD_IMPRIME_OS"."OS_TROCA_FUSAO"'
      FixedChar = True
      Size = 1
    end
    object QryOSOS_TROCA_BELT: TIBStringField
      FieldName = 'OS_TROCA_BELT'
