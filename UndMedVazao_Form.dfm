object frmUndMedVazao: TfrmUndMedVazao
  Left = 201
  Top = 206
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Unidades de Medida por Dosagem/Vaz'#227'o'
  ClientHeight = 259
  ClientWidth = 473
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object cmbUndDE: TdxDBLookupEdit
      Left = 20
      Top = 112
      Width = 408
      Font.Charset = DEFAULT_CHARSET
    ...
    object cmbUndPA: TdxDBLookupEdit
      Left = 20
      Top = 156
      Width = 407
      Font.Charset = DEFAULT_CHARSET
  ...
  object DataSource: TDataSource
    DataSet = dmCadastros2.AGR_Und_Med_Vazao
    OnStateChange = DataSourceStateChange
    OnDataChange = DataSourceDataChange
    Left = 111
    Top = 192
  end
  object dsUndPA: TDataSource
