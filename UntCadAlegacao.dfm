inherited frmCadAlegacao: TfrmCadAlegacao
  Left = 225
  Top = 210
  Caption = 'Alega'#231#245'es'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited dtEdit: TIBDataSet
    DeleteSQL.Strings = (
      'delete from FIN_MOTIVO_COBRANCA'
      'where'
      '  CNPJ = :OLD_CNPJ and'
      '  CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'insert into FIN_MOTIVO_COBRANCA'
      '  (CNPJ, CODIGO, NOME)'
      'values'
      '  (:CNPJ, :CODIGO, :NOME)')
    RefreshSQL.Strings = (
    ...
    GeneratorField.Generator = 'FIN_MOTIVO_COBRANCA_GE'
  ...
  inherited dtList: TIBQuery
    ...
    object dtListCNPJ: TIBStringField
      FieldName = 'CNPJ'
      Origin = '"FIN_MOTIVO_COBRANCA"."CNPJ"'
    ...
    object dtListCODIGO: TIntegerField
      ...
      FieldName = 'CODIGO'
      Origin = '"FIN_MOTIVO_COBRANCA"."CODIGO"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object dtListNOME: TIBStringField
      DisplayLabel = 'Nome'
      FieldName = 'NOME'
      Origin = '"FIN_MOTIVO_COBRANCA"."NOME"'
      Size = 50
    end
  end
