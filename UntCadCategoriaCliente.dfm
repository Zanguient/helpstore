inherited FrmCadCategoriaCliente: TFrmCadCategoriaCliente
  ...
  inherited dtEdit: TIBDataSet
    DeleteSQL.Strings = (
      'delete from glo_clientes_categoria'
      'where'
      '  CNPJ = :OLD_CNPJ and'
      '  CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'insert into glo_clientes_categoria'
      '  (CNPJ, CODIGO, NOME)'
      'values'
      '  (:CNPJ, :CODIGO, :NOME)')
    RefreshSQL.Strings = (
      'Select *'
      'from glo_clientes_categoria '
      'where'
      '  CNPJ = :CNPJ and'
      '  CODIGO = :CODIGO')
    SelectSQL.Strings = (
      ...
      '           CODIGO,'
      '           NOME '
      'from glo_clientes_categoria c'
      'WHERE CNPJ = :CNPJ'
      'and codigo = :codigo')
    ModifySQL.Strings = (
      'update glo_clientes_categoria'
      'set'
      '  CNPJ = :CNPJ,'
      '  CODIGO = :CODIGO,'
      '  NOME = :NOME'
