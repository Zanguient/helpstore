unit UntCadProblemaIdentificado;
...
type
  TfrmCadMotivoChamado = class(TfrmCadPadrao)
    ...
    dtEditPADRAO_PREVENTIVA: TIBStringField;
    dtListPADRAO_PREVENTIVA: TIBStringField;
    GridDBBandedTableView2PADRAO_PREVENTIVA: TcxGridDBBandedColumn;
...
{$R *.dfm}
procedure TfrmCadMotivoChamado.dtEditNewRecord(DataSet: TDataSet);
begin
  inherited;
  dtEditPADRAO_PREVENTIVA.value := 'N';
  dtEditATIVO.value := 'S';
end;

initialization
 RegisterClass(TfrmCadMotivoChamado);
