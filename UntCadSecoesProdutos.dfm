inherited frmCadSecoesProdutos: TfrmCadSecoesProdutos
    ...
    inherited tbsLista: TcxTabSheet
      inherited Grid: TcxGrid
        ...
        inherited GridDBBandedTableView2: TcxGridDBBandedTableView
          ...
          object GridDBBandedTableView2COD_SECAO: TcxGridDBBandedColumn
            DataBinding.FieldName = 'COD_SECAO'
            Position.BandIndex = 0
            Position.ColIndex = 1
            Position.RowIndex = 0
          end
    ...
    inherited tbsEdita: TcxTabSheet
      inherited Panel2: TPanel
        ...
        inherited edtCodigo: TcxDBTextEdit
          DataBinding.DataField = 'COD_SECAO'
        end
      end
    end
  end
  inherited dtEdit: TIBDataSet
    DeleteSQL.Strings = (
      'delete from est_secao'
      'where'
      '  CNPJ = :OLD_CNPJ and'
      '  COD_SECAO = :OLD_COD_SECAO')
    InsertSQL.Strings = (
      'insert into est_secao'
      '  (CNPJ, COD_SECAO, NOME)'
      'values'
      '  (:CNPJ, :COD_SECAO, :NOME)')
    RefreshSQL.Strings = (
    ...
    ModifySQL.Strings = (
      ...
      '  CNPJ = :OLD_CNPJ and'
      '  COD_SECAO = :OLD_COD_SECAO')
    GeneratorField.Field = 'COD_SECAO'
    GeneratorField.Generator = 'GEN_EST_SECAO_ID'
    ...
    object dtEditCOD_SECAO: TIntegerField
      FieldName = 'COD_SECAO'
  ...
  inherited cxPropertiesStore: TcxPropertiesStore
    Components = <
      ...
      item
        Component = GridDBBandedTableView2COD_SECAO
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
