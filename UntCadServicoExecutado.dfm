inherited frmCadServicoExecutado: TfrmCadServicoExecutado
  Left = 219
  Top = 184
    ...
    inherited tbsLista: TcxTabSheet
      inherited Grid: TcxGrid
        inherited GridDBBandedTableView2: TcxGridDBBandedTableView
          ...
          object GridDBBandedTableView2RETORNO: TcxGridDBBandedColumn
  ...
  inherited dtList: TIBQuery
    ...
    object dtListRETORNO: TIBStringField
  ...
  inherited cxPropertiesStore: TcxPropertiesStore
    Components = <
      ...
      item
        Component = GridDBBandedTableView2RETORNO
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
