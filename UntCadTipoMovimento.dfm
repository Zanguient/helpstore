inherited frmCadTipoMovimento: TfrmCadTipoMovimento
  ...
  inherited dtEdit: TIBDataSet
    DeleteSQL.Strings = (
      'delete from ofc_tipo_movto'
      'where'
      '  CNPJ = :OLD_CNPJ and'
      '  CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'insert into ofc_tipo_movto'
      '  (CNPJ, CODIGO, NOME)'
      'values'
      '  (:CNPJ, :CODIGO, :NOME)')
    RefreshSQL.Strings = (
    ...
    GeneratorField.Generator = 'GEN_OFC_TIPO_MOVTO_ID'
