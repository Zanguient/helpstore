...
begin
  ...
  If cmbNatureza.Text = '' Then
     DMRelatorios.Fat_VendasPorProduto.ParamByName('cod_natureza').Value:= 0
  Else
     DMRelatorios.Fat_VendasPorProduto.ParamByName('cod_natureza').Value:= DsNatureza.DataSet.fieldByName('CODIGO').Value ;
  ...
  While Not DMRelatorios.Fat_VendasPorProduto.Eof Do
        Begin
          ...
          If Cod_Produto <> DmRelatorios.Fat_VendasPorProdutoPRODUTO.Value Then
             Begin
               Print.ImpF(Linha,01,'Produto : ' + DmRelatorios.Fat_VendasPorProdutoPRODUTO.Text + ' -- ' + DmRelatorios.Fat_VendasPorProdutoNOME_PRODUTO.Text,[Comp17, Negrito]);
