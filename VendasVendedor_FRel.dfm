object FRelVendasVendedor: TFRelVendasVendedor
  Left = 240
  Top = 166
  BorderStyle = bsDialog
  Caption = 'Rel. Vendas e Trocas por Vendedor'
  ClientHeight = 256
  ClientWidth = 498
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object ckVdCancelada: TdxCheckEdit
      Left = 321
      Top = 187
      Width = 160
      Font.Charset = DEFAULT_CHARSET
      ...
      OnExit = FimExit
      OnKeyDown = cmbPessoaKeyDown
      Caption = 'Incluir Vendas Canceladas'
    end
  end
  ...
  object dsUsuario: TDataSource
    DataSet = DMRelatorios.lkpUsuario
    Left = 464
    Top = 4
  end
end
