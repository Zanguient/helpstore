  ...
  object Vendas: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into FAT_VENDAS'
        ...
        '   TRP_CIDADE, TRP_CPF_CNPJ, TRP_ESPECIE, TRP_MARCA, TRP_NOME, T' +
        'RP_NUMERO, '
      
        '   TRP_PESO_BRUTO, TRP_PESO_LIQUIDO, TRP_QTDE, TURNO, UF, UF_PLA' +
        'CA, USUARIO, '
      
        '   VALE_TROCO, VALIDADE, VALOR_ICM_SUBST, VENDEDOR, VLR_PARC_LC,' +
        ' VOLUME)'
      'values'
