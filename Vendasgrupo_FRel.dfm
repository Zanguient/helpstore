object FRelVendasGrupos: TFRelVendasGrupos
  Left = 175
  Top = 148
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio das Vendas Por Grupos'
  ClientHeight = 199
  ClientWidth = 482
  Color = clWhite
  ...
  object pnlClient: TPanel
    ...
    object CkSintetico: TdxCheckEdit
      Left = 106
      Top = 129
      Width = 67
      Font.Charset = DEFAULT_CHARSET
  ...
  object stgFRelVendasGrupos: TcxPropertiesStore
    Components = <
      item
        Component = CkSintetico
        Properties.Strings = (
          'Alignment'
          'AllowGrayed'
          'Anchors'
    ...
    StorageName = 'stgFRelVendasGrupos'
    Left = 224
    Top = 79
  end
end
