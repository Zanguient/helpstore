object FrmVerAgendamentoCobranca: TFrmVerAgendamentoCobranca
  Left = 196
  Top = 105
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Agendamentos de Cobran'#231'a '
  ClientHeight = 434
  ClientWidth = 757
  Color = 15396334
  ...
  object pnlClient: TPanel
    ...
    object LblTitulo: TcxLabel
      Left = 6
      Top = 8
      Caption = 'Visualizar Agendamentos de Cobran'#231'a'
      ParentFont = False
      Transparent = True
    end
    ...
    object GRID: TdxDBGrid
      ...
      object GRIDVENCIMENTO: TdxDBGridColumn
        BandIndex = 0
        RowIndex = 0
        FieldName = 'DT_VENCTO'
      end
  ...
  object DataSource: TDataSource
    AutoEdit = False
    DataSet = DmFinanceiro.Historico_Cobrancas_Pcl
    OnDataChange = DataSourceDataChange
    Left = 461
    Top = 104
  end
  object stgFrmVerAgendamentoCobranca: TcxPropertiesStore
    Components = <
      item
        Component = GRID
        Properties.Strings = (
    ...
    StorageName = 'stgFrmVerAgendamentoCobranca'
    Left = 200
    Top = 103
  end
end
