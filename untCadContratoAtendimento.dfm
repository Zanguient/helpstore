inherited frmCadContratoAtendimento: TfrmCadContratoAtendimento
                ...
                inherited tbsListaSub1: TcxTabSheet
                  inherited GridDet1: TcxGrid
                    ...
                    inherited TVDet1: TcxGridDBBandedTableView
                      ...
                      object TVDet1TEMPO_RESPOSTA_PREV: TcxGridDBBandedColumn
                        DataBinding.FieldName = 'TEMPO_RESPOSTA_PREV'
                        Width = 114
                        Position.BandIndex = 1
                        Position.ColIndex = 3
                        Position.RowIndex = 0
                ...
                inherited tbsEditaSub1: TcxTabSheet
                  ...
                  object cxGroupBox3: TcxGroupBox
                    ...
                    object cxDBSpinEdit4: TcxDBSpinEdit
                      ...
                      Top = 32
                      Hint = 'Tempo de resposta definido em contrato. '
                      DataBinding.DataField = 'TEMPO_RESPOSTA_PREV'
                      DataBinding.DataSource = dsRegistroDet1
                      ParentFont = False
                      ParentShowHint = False
                      Properties.MaxValue = 365.000000000000000000
  ...
  inherited dtList: TIBQuery
    SQL.Strings = (
      ...
      'from ofc_contratos cp'
        ...
        'left join ofc_mecanicos tec on (tec.cnpj = reg.cnpj and tec.codi' +
        'go = reg.tecnico)'
    ...
    object dtListREGIAO: TIBStringField
      DisplayLabel = 'Regi'#227'o'
      FieldName = 'REGIAO'
      Origin = '"GLO_REGIOES"."NOME"'
      Size = 50
    end
    object dtListTECNICO: TIBStringField
  ...
  inherited cxPropertiesStore: TcxPropertiesStore
    Components = <
      ...
      item
        Component = TVDet1TEMPO_RESPOSTA_PREV
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
      ...
      item
        Component = TVDet1TIPO_DIGITALIZACAO
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
  ...
  inherited dtListDet1: TIBQuery
    ...
    object dtListDet1TEMPO_RESPOSTA_PREV: TIntegerField
      DisplayLabel = 'Tempo Resposta Prev.'
      FieldName = 'TEMPO_RESPOSTA_PREV'
  ...
  inherited dtEditDet1: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into ofc_contratos_itens'
        ...
        '   TEMPO_RESPOSTA, TEMPO_RESPOSTA_PREV, TIPO_COLORIDO, TIPO_DIGI' +
        'TALIZACAO, '
      ...
      'values'
        ...
        '   :QTDE_COPIAS_PREVENTIVA, :TEMPO_RESPOSTA, :TEMPO_RESPOSTA_PRE' +
        'V, :TIPO_COLORIDO, '
      
        '   :TIPO_DIGITALIZACAO, :VALOR, :VMC_COD_UPD, :VMC_DATA_UPD, :VM' +
        'C_TIPO_UPD)')
    RefreshSQL.Strings = (
      'Select * '
    ...
    ModifySQL.Strings = (
      ...
      '  TEMPO_RESPOSTA_PREV = :TEMPO_RESPOSTA_PREV,'
    ...
    object dtEditDet1ATIVO: TIBStringField
      FieldName = 'ATIVO'
      Origin = '"OFC_CONTRATOS_ITENS"."ATIVO"'
      OnChange = dtEditDet1ATIVOChange
      FixedChar = True
      Size = 1
    end
    ...
    object dtEditDet1TEMPO_RESPOSTA_PREV: TIntegerField
      FieldName = 'TEMPO_RESPOSTA_PREV'
      Origin = '"OFC_CONTRATOS_ITENS"."TEMPO_RESPOSTA_PREV"'
    end
  end
