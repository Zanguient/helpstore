...
uses
  ...
  cxPC, StdCtrls, ComCtrls, DBCtrls;

type
  TfrmCadHelp = class(TfrmCadPadrao)
    dtListCNPJ: TIBStringField;
    dtListCODIGO: TIntegerField;
    dtListFORMULARIO: TIBStringField;
    dtListCONFIG: TMemoField;
    dtEditCNPJ: TIBStringField;
    dtEditCODIGO: TIntegerField;
    dtEditFORMULARIO: TIBStringField;
    dtEditCONFIG: TMemoField;
    GridDBBandedTableView2CNPJ: TcxGridDBBandedColumn;
    GridDBBandedTableView2CODIGO: TcxGridDBBandedColumn;
    GridDBBandedTableView2FORMULARIO: TcxGridDBBandedColumn;
    GridDBBandedTableView2CONFIG: TcxGridDBBandedColumn;
...
var
  frmCadHelp: TfrmCadHelp;

implementation

{$R *.dfm}
initialization
 RegisterClass(TfrmCadHelp);
