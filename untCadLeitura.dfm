inherited frmCadLeituras: TfrmCadLeituras
    ...
    inherited tbsLista: TcxTabSheet
      inherited Grid: TcxGrid
        ...
        inherited TVRegistro: TcxGridDBBandedTableView
          ...
          object TVRegistroDESC_ACRESC_TOTAL: TcxGridDBBandedColumn
            DataBinding.FieldName = 'DESC_ACRESC_TOTAL'
            Width = 95
            Position.BandIndex = 0
            ...
            inherited tbsMaster1: TcxTabSheet
              ...
              object cxGroupBox3: TcxGroupBox
                ...
                object cxDBCalcEdit1: TcxDBCalcEdit
                  Left = 251
                  Top = 32
                  DataBinding.DataField = 'DESC_ACRESC_TOTAL'
                  DataBinding.DataSource = dsRegistro
                  TabOrder = 10
                  Width = 81
                end
  ...
  inherited dtEdit: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into ofc_leituras'
        ...
        '   DATA, DATA_REFERENCIA, DESC_ACRESC_CP, DESC_ACRESC_TOTAL, FEC' +
        'HADA, GERA_FATURAMENTO, '
      
        '   OBSERVACAO, PERIODO, TOTAL_COPIAS, VALOR_LEITURA, VALOR_TOTAL' +
        '_COPIAS_EXCENTE, '
      '   VENDA)'
      'values'
        ...
        '   :DESC_ACRESC_TOTAL, :FECHADA, :GERA_FATURAMENTO, :OBSERVACAO,' +
        ' :PERIODO, '
      
        '   :TOTAL_COPIAS, :VALOR_LEITURA, :VALOR_TOTAL_COPIAS_EXCENTE, :' +
        'VENDA)')
    RefreshSQL.Strings = (
      'Select *'
      'from ofc_leituras '
    ...
    ModifySQL.Strings = (
      ...
      '  DESC_ACRESC_TOTAL = :DESC_ACRESC_TOTAL,'
      '  FECHADA = :FECHADA,'
    ...
    object dtEditCONTRATO: TIntegerField
      ...
      OnValidate = dtEditCONTRATOValidate
    end
    ...
    object dtEditDESC_ACRESC_TOTAL: TFloatField
      FieldName = 'DESC_ACRESC_TOTAL'
      Origin = '"OFC_LEITURAS"."DESC_ACRESC_TOTAL"'
      OnValidate = dtEditDESC_ACRESC_TOTALValidate
    end
  end
  inherited dtList: TIBQuery
    ...
    object dtListDESC_ACRESC_TOTAL: TFloatField
      DisplayLabel = 'Acr'#233'scim. Total'
      FieldName = 'DESC_ACRESC_TOTAL'
      Origin = '"OFC_LEITURAS"."DESC_ACRESC_TOTAL"'
    end
  end
