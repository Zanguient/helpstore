inherited frmCadOS: TfrmCadOS
    ...
    inherited tbsLista: TcxTabSheet
      inherited Grid: TcxGrid
        ...
        inherited TVRegistro: TcxGridDBBandedTableView
          ...
          object TVRegistroMTC_PADRAO_PREVENTIVA: TcxGridDBBandedColumn
            DataBinding.FieldName = 'MTC_PADRAO_PREVENTIVA'
          ...
          object TVRegistroCP_TEMPO_RESPOSTA_PREV: TcxGridDBBandedColumn
            DataBinding.FieldName = 'CP_TEMPO_RESPOSTA_PREV'
            Position.BandIndex = 0
  ...
  inherited dtList: TIBQuery
    ...
    SQL.Strings = (
      ...
      'mtc.nome mtc_nome,'
      'coalesce(mtc.padrao_preventiva,'#39'N'#39') mtc_padrao_preventiva,'
      ...
      'cti.tempo_resposta_prev cp_tempo_resposta_prev,'
      'ofc.custo_os,'
      'ofc.informacoes,'
      'ofc.obs_fechamento,'
      'v.modelo veiculo,'
      ...
      'from ofc_ordem_servico ofc'
        ...
        'i.cod_produto = ofc.produto and ofc.id_contrato = cti.contrato a' +
        'nd cti.ativo = '#39'S'#39')'
    ...
    object dtListMTC_PADRAO_PREVENTIVA: TIBStringField
      DisplayLabel = 'Motiv. Chamado Padr'#227'o Visita Preventiva'
      FieldName = 'MTC_PADRAO_PREVENTIVA'
      Origin = '"OFC_MOTIVO_CHAMADO"."PADRAO_PREVENTIVA"'
      FixedChar = True
      Size = 1
    end
    object dtListCP_TEMPO_RESPOSTA_PREV: TIntegerField
      DisplayLabel = 'Tempo Resposta Prev.'
      FieldName = 'CP_TEMPO_RESPOSTA_PREV'
      Origin = '"OFC_CONTRATOS_ITENS"."TEMPO_RESPOSTA_PREV"'
    end
  end
  ...
  inherited cxPropertiesStore: TcxPropertiesStore
    Components = <
      ...
      item
        Component = TVRegistroCP_TEMPO_RESPOSTA_PREV
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
      ...
      item
        Component = TVRegistroMTC_PADRAO_PREVENTIVA
        Properties.Strings = (
          'AlternateCaption'
          'BestFitMaxWidth'
          'Caption'
  ...
  object SelSeries: TIBQuery
    ...
    SQL.Strings = (
        ...
        'left join ofc_contratos o on (o.cnpj = i.cnpj and o.codigo = i.c' +
        'ontrato)'
      
        'left join glo_pessoas_fj psa on (psa.cnpj =o.cnpj and psa.codigo' +
        ' = o.cod_cliente)'
