...
uses  Application_DM, untHelpPadrao;
...
procedure TfrmCadPadraoMaster.btnHelpClick(Sender: TObject);
begin
  inherited;
  ...
  begin
    ...
    begin
      ...
      qryVerificaHelp.parambyname('formulario').value := UpperCase(TfrmCadPadraoMaster(owner).Name);
      ...
      begin
        caption :=  'Help - '+TfrmCadPadraoMaster(owner).Caption;
        Showmodal;
      end;
    end;
