inherited frmCadProdutos: TfrmCadProdutos
  ...
  inherited dtEdit: TIBDataSet
    ...
    InsertSQL.Strings = (
      ...
      'values'
        ...
        '   :PRC_CUSTO_MED, :PRC_REPOS, :PRC_VENDA, :PRC_VENDA_ANT, :PRC_' +
        'VENDA_MED, '
      
        '   :PREVISAO_ENTREGA, :PROD_PESAVEL, :QNTDE_EXPOSTA, :QNTDE_MAXI' +
        'MA_VENDA, '
    ...
    object dtEditDT_ULT_COMPRA: TDateField
    ...
    object dtEditDT_ULT_VENDA: TDateField
    ...
    object dtEditDT_ULT_ATU_PRECO: TDateField
    ...
    object dtEditPREVISAO_ENTREGA: TDateField
    ...
    object dtEditFATOR_CONVERSAO: TIBBCDField
    ...
    object dtEditQNTDE_PDR_CARGA: TIBBCDField
    ...
    object dtEditTRIB_ALIQ_EST: TIBBCDField
      FieldName = 'TRIB_ALIQ_EST'
      Origin = '"PCD_LISTA_PRODUTO"."TRIB_ALIQ_EST"'
      Precision = 18
      Size = 4
    end
    object dtEditTRIB_ALIQ_INT: TIBBCDField
    ...
    object dtEditEST_DISPONIVEL: TIBBCDField
  ...
  inherited dtList: TIBQuery
    ...
    object dtListMARCA: TIBStringField
      DisplayLabel = 'Marca'
      FieldName = 'MARCA'
    ...
    object dtListMDL_CODIGO: TIntegerField
      DisplayLabel = 'Mdl C'#243'digo'
      FieldName = 'MDL_CODIGO'
      Origin = '"GLO_MODELO_PROPRIEDADE"."CODIGO"'
    end
    object dtListMODELO: TIBStringField
      DisplayLabel = 'Modelo'
      FieldName = 'MODELO'
      Origin = '"GLO_MODELO_PROPRIEDADE"."NOME"'
      Size = 50
    end
    object dtListSECAO: TIBStringField
