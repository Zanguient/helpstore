object frmManutencaoPadrao: TfrmManutencaoPadrao
  ...
  object NavBar: TdxNavBar
    ...
    TabOrder = 0
    View = 14
    object brFuncoes: TdxNavBarGroup
    ...
    object brPosicoes: TdxNavBarGroup
    ...
    object brCotacoes: TdxNavBarGroup
    ...
    object nvFuncao1: TdxNavBarItem
      Caption = 'Fun'#231#227'o 1'
      LargeImageIndex = 1
      SmallImageIndex = 1
    end
    object nvFuncao2: TdxNavBarItem
      Caption = 'Fun'#231#227'o 1'
      LargeImageIndex = 2
      SmallImageIndex = 2
    end
    object nvFuncao3: TdxNavBarItem
      Caption = 'Fun'#231#227'o 1'
      LargeImageIndex = 19
      SmallImageIndex = 19
    end
  ...
  object pgcPrincipal: TcxPageControl
    ...
    Align = alClient
    TabOrder = 1
    OnExit = pnlFiltro1Exit
    ClientRectBottom = 432
    ClientRectLeft = 4
    ClientRectRight = 665
    ClientRectTop = 27
    object tbsMain1: TcxTabSheet
      Caption = 'Aba 1'
      ImageIndex = 0
      object Grid1: TcxGrid
        ...
        Align = alClient
        TabOrder = 0
        object Grid1TV: TcxGridDBBandedTableView
        ...
        object Grid1LV: TcxGridLevel
          GridView = Grid1TV
        end
      end
      object pnlFiltro1: TcxGroupBox
        Left = 0
        Top = 0
        Align = alTop
        Caption = 'T'#237'tulo ( Filtro ou Edi'#231#227'o )'
        TabOrder = 1
        OnExit = pnlFiltro1Exit
        Height = 81
        Width = 661
    ...
    object tbsMain2: TcxTabSheet
      Caption = 'Aba 2'
      ImageIndex = 1
      object pnlFiltro2: TcxGroupBox
        Left = 0
        Top = 0
        Align = alTop
        Caption = 'T'#237'tulo ( Filtro ou Edi'#231#227'o )'
      ...
      object Grid2: TcxGrid
        ...
        Align = alClient
        TabOrder = 1
        object Grid2TV: TcxGridDBBandedTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
        ...
        object Grid2LV: TcxGridLevel
          GridView = Grid2TV
        end
      end
    end
    object tbsMain3: TcxTabSheet
      Caption = 'Aba 3'
      ImageIndex = 2
      object pnlFiltro3: TcxGroupBox
        Left = 0
        Top = 0
        Align = alTop
        Caption = 'T'#237'tulo ( Filtro ou Edi'#231#227'o )'
      ...
      object Grid3: TcxGrid
        ...
        Align = alClient
        TabOrder = 1
        object Grid3TV: TcxGridDBBandedTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
  ...
  object ActionList1: TActionList
    ...
    object ActFirst: TAction
      Caption = 'Primeiro Registo'
      Hint = 'Primeiro Registo'
      ImageIndex = 7
      ShortCut = 16420
    ...
    object ActNext: TAction
      Caption = 'Pr'#243'ximo Registo'
      Hint = 'Pr'#243'ximo Registo'
      ImageIndex = 6
    end
    ...
    object ActContrair: TAction
      Caption = 'Contrair Registros'
      Hint = 'Contrair Registros'
      ImageIndex = 31
      OnExecute = ActContrairExecute
    end
    object ActExpandir: TAction
      Caption = 'Expandir Registros'
      Hint = 'Expandir Registros'
      ImageIndex = 33
  ...
  object dsLista1: TDataSource
    DataSet = QryLista1
    Left = 205
    Top = 155
  end
  object dsLista2: TDataSource
    DataSet = QryLista2
    Left = 253
    Top = 155
  end
  ...
  object QryLista1: TIBQuery
    BeforeOpen = QryLista1BeforeOpen
    Left = 205
    Top = 195
  end
  object QryLista2: TIBQuery
    BeforeOpen = QryLista1BeforeOpen
    Left = 253
    Top = 195
  end
  object QryLista3: TIBQuery
    BeforeOpen = QryLista1BeforeOpen
    Left = 293
    Top = 195
  end
